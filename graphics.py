...
class Cell:
    ...
    def area(self):
        horizontal_line = Line(Point(self.__x1, self.__y1), Point(self.__x1, self.__y2))
        vertical_line = Line(Point(self.__x1, self.__y1), Point(self.__x2, self.__y1))
        return horizontal_line.get_length() * vertical_line.get_length()
